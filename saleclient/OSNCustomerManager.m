...
- (NSArray *)getAddressListWithCustomerId:(NSString *)customerId {
    ...
    for (NSDictionary *item in dataArr) {
        ...
        address.addressId = item[@"addressId"];
        address.name = item[@"name"];
        address.contactPhone = [item[@"contactPhone"] isEqual:[NSNull null]] ? nil : item[@"contactPhone"];
        address.provinceId = [item[@"provinceId"] isEqual:[NSNull null]] ? nil : item[@"provinceId"];
        address.provinceName = [item[@"provinceName"] isEqual:[NSNull null]] ? nil : item[@"provinceName"];
        address.cityId = [item[@"cityId"] isEqual:[NSNull null]] ? nil : item[@"cityId"];
        address.cityName = [item[@"cityName"] isEqual:[NSNull null]] ? nil : item[@"cityName"];
        address.areaId = [item[@"areaId"] isEqual:[NSNull null]] ? nil : item[@"areaId"];
        address.areaName = [item[@"areaName"] isEqual:[NSNull null]] ? nil : item[@"areaName"];
        address.state = [item[@"state"] integerValue];
        address.buildingId = [item[@"buildingId"] isEqual:[NSNull null]] ? nil : item[@"buildingId"];
        address.buildingName = [item[@"buildingName"] isEqual:[NSNull null]] ? nil : item[@"buildingName"];
        address.address = [item[@"address"] isEqual:[NSNull null]] ? nil : item[@"address"];
        address.buildingNo = [item[@"buildingNo"] isEqual:[NSNull null]] ? nil : item[@"buildingNo"];
        address.room = [item[@"room"] isEqual:[NSNull null]] ? nil : item[@"room"];
